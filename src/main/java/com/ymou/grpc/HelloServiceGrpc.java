...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ymou.grpc.HelloRequest,
      com.ymou.grpc.HelloResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greet",
      requestType = com.ymou.grpc.HelloRequest.class,
      responseType = com.ymou.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.ymou.grpc.HelloRequest,
      com.ymou.grpc.HelloResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.ymou.grpc.HelloRequest, com.ymou.grpc.HelloResponse> getGreetMethod;
    if ((getGreetMethod = HelloServiceGrpc.getGreetMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getGreetMethod = HelloServiceGrpc.getGreetMethod) == null) {
          HelloServiceGrpc.getGreetMethod = getGreetMethod = 
              io.grpc.MethodDescriptor.<com.ymou.grpc.HelloRequest, com.ymou.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "HelloService", "greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ymou.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ymou.grpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greet(com.ymou.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.ymou.grpc.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.ymou.grpc.HelloRequest,
                com.ymou.grpc.HelloResponse>(
                  this, METHODID_GREET)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.ymou.grpc.HelloResponse greet(com.ymou.grpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ymou.grpc.HelloResponse> greet(
        com.ymou.grpc.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.ymou.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.ymou.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ymou.grpc.HelloServiceOuterClass.getDescriptor();
    }
